...
export const subjectGradeEnum = pgEnum("subject_grade", [
  "A", "B", "C", "D", "E", "F", "U", "1", "2", "3", "4", "5", "6", "7", "8", "9",
]);
...
export const examResults = pgTable("exam_results", {
  ...
  results: jsonb("results").$type<{ subject: string; grade: string }[]>().default([]),
...
export const zoeConversations = pgTable("zoe_conversations", {
  ...
  messages: jsonb("messages").$type<{ role: "user" | "model"; content: string; timestamp: string }[]>().default([]),
...
export const careerPaths = pgTable("career_paths", {
  ...
  requiredGrades: jsonb("required_grades"),
  isVocational: boolean("is_vocational").default(false),
  partnerInstitutions: jsonb("partner_institutions").$type<string[]>().default([]),
